...
Download Ratings Data Ñ This is a comma-separated values file, with the user number, movie ID, and rating, in that order.

Download Movies List Ñ Decoding the movie title is not required for this assignment, but are you curious which movie is which in the ratings file? Use this file to find out!

Download Users List Ñ Decoding the unique user id is not required for this assignment, but use this file to find your user number using the unique identifier that was provided to you after rating the movies.
...
Get my 3 movie assignments (your user ID can be found on the assignments index page)
